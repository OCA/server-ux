...
export class AnnouncementMenu extends Component {
    setup () {
        ...
        this.orm.call("res.users", "read", [session.uid, ["login_date"]])
        .then((user) => {
    ...
    _getAnnouncementData () {
        // return this.orm.call("res.users", "announcement_user_count", [],
        //     {
     ...
     */
    _buildAnnouncementDialog (announcement) {
...
registry.category("systray").add("announcement.announcement_menu", systrayAnnouncement, {sequence: 100})
