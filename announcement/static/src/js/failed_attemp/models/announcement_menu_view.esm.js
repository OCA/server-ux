...
registerModel({
    ...
    recordMethods: {
        ...
        async fetchData() {
            this.announcements = await this.messaging.rpc({
                model: 'res.users',
            ...
            this.announcements;
            this.update({
                announcements: data.map(vals => this.messaging.models['AnnouncementItem'].convertData(vals)),
                extraCount: 0,
            });
        },
        /**
    ...
    fields: {
        announcements: many('ActivityGroup', {
        ...
        // counter: attr({
        //     compute() {
        //         return this.announcements.reduce((total, group) => total + group.total_count, this.extraCount);
        //     },
        // }),
        counter: attr(),
        /**
