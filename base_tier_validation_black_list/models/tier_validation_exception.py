...
class TierValidationException(models.Model):
    ...
    field_ids = fields.Many2many(
        required=False, # Se lo hará requerido siempre y cuando is_blacklist no esté activo
        # Esto permite que el modelo sea editable en cualquier momento de la validación
    )
